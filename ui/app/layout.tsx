...
export const metadata: Metadata = {
  ...
  description:
    "A comprehensive collection of Python scripts designed to simplify your daily routine. From automation to productivity tools, streamline your workflow with PyEveryday.",
  keywords: [
    "Python",
    "automation",
    "scripts",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${spaceGrotesk.variable} ${chivoMono.variable}`}
    >
      <head>
